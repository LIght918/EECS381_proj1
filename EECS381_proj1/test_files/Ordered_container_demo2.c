...
void find_and_remove(struct Ordered_container * container, struct Point_2D  probe);
...
int main(void)
{
    ...
    struct Point_2D s1 = {1, 1};
    struct Point_2D s2 = {1, 2};
    struct Point_2D s3 = {2, 1};
    struct Point_2D s4 = {2, 2};
    struct Point_2D probe1 = {1, 2};
    struct Point_2D probe2 = {99, 99};
...
void print_as_Point(void * data_ptr)
{
    ...
    struct Point_2D * ptr = (struct Point_2D *)data_ptr;
    printf("(%d, %d)\n", ptr->x, ptr->y);
...
int compare_Points(const void * data_ptr1, const void * data_ptr2)
{
    ...
    if(((struct Point_2D *)data_ptr1)->x != ((struct Point_2D *)data_ptr2)->x)
        return (((struct Point_2D *)data_ptr1)->x - ((struct Point_2D *)data_ptr2)->x);
    return (((struct Point_2D *)data_ptr1)->y - ((struct Point_2D *)data_ptr2)->y);
}
...
void find_and_remove(struct Ordered_container * container, struct Point_2D probe)
{
    ...
    if(found_item) {
        struct Point_2D * p = (struct Point_2D *)OC_get_data_ptr(found_item);
